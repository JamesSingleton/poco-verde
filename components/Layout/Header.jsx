          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <Link href="/">
                  <a className="focus:outline-none focus:ring-2 focus:ring-inset focus:ring-emerald-500">
                    <span className="sr-only">Poco Verde Logo</span>
                    <SmallLogo classes="h-8 w-auto sm:h-10" />
                  </a>
                </Link>
              </div>
              ...
              <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                <Link href="/finance">
                  <a className="text-base font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-emerald-500">
                    Finance
                  </a>
                </Link>
